...
# Load data produced by `process.R`.
...
MAKE_GG_PLOTS <- FALSE # KEEP THIS FALSE -- see ~/Figures/gg3DayPlots.
MAKE_QUILT_PLOTS <- FALSE # KEEP THIS FALSE -- see ~/Figures/3DayPlots.
MAKE_TIME_SERIES <- TRUE # Produce quadrant time-series plots.
...
## Some summary statistics: these can be found in the report section 3.1.1.
if (STATS) {
...
##########################
# This code was not updated to reflect the addition of 2 more months of data.
# Do not run these.
##########################
# if (MAKE_QUILT_PLOTS) {
...
## Seasonal distributions (for four quadrants). These can be found in Michael's
## presentation.
if (RESO == 2) {
