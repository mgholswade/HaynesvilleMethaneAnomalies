...
## Create the plots.
t <- expression(paste('on a log'[10], ' scale', sep = '')) # subtitle for figure below.

# This produces a plot of texas cattle population on a log10 scale.
# This is Figure 26 in the Appendix in our report.
pdf(file = '../../figures/other/TexasCattle.pdf', height = 5.0, width = 6.66)
