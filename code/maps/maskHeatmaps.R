...
# Quick quilt-plot of proportion of high-qa values.
quilt.plot(X$longitude, X$latitude, X$qa_value == 1.0,
           col = viridis(64))#, zlim = c(0, 1))
US(add = TRUE, lwd = 3.0)


## Divide up data into RESO^2 quadrants.
RESO <- 100
...
# Construct dataframe with qa-proportion data.
...
# This is the plot of proportion of high-qa values: Figure 11 in our report.
pdf(file = '../../figures/maps/qa.pdf', height = 3.0, width = 4.5)
basemap.hybrid +
...
# Get proportion of days, by quadrant, of above-average methane levels.
# This is Figure 12b in our report.
...
###########################################################################
# The following code is exploratory analysis, and did not make it into our
# report. DO NOT RUN.
###########################################################################
