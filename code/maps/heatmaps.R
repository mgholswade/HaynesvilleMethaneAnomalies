...
## For document. These are the proportion statistics presented in section
## 3.2 of the report. RESO must be set to 2.
if (RESO == 2) {
...
## HEATMAPS
# Daily proportion matrix -- estimated proportion of days with above-average
# methane levels.
...
# Heatmap with geo-map underlaid. This is Figure 8 in our report.
...
########################################################
# These plots were not used in the report, and are no
# longer in our Dropbox. Leave uncommented.
########################################################
