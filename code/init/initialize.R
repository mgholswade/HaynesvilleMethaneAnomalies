...
# MUST BE IN THE 'CODE' DIRECTORY TO RUN PROPERLY
...
file_path = "../../Data/data-full/data"
outfile_name = "../../Data/data-full/varDictFull.Rdata"
file_names = list.files(file_path)[1:1000] # Check to see how many .nc files you have in your directory! May not be 15
